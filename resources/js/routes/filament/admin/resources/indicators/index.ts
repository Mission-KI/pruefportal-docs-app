...
/**
* @see \App\Filament\Resources\Indicators\Pages\ViewIndicator::__invoke
* @see Filament/Resources/Indicators/Pages/ViewIndicator.php:7
* @route '/admin/indicators/{record}'
*/
